...
//    }
    ...
    @ExceptionHandler(TierdYolException.class)// istisnayı yakalayan kısım
    @ResponseBody
    public ResponseEntity<ErrorMessage> tierdYolExceptionHandler(TierdYolException exception){
